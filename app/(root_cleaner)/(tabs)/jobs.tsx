...
import { SkeletonCard } from '@/components/HostDashboardCardSkeleton';
               ...
               <FlatList
                          ...
                          ListEmptyComponent={
                            <View className="items-center py-8">
                              <Text className="text-gray-500">No jobs scheduled for today</Text>
                            </View>
                          }
                        />
          ) : (
            <View className=" rounded-lg p-8 items-center justify-center mt-40">
