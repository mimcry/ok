...
export default function CleanerDashboardCard({
    jobs,
    onCall,
    ...
    console.log("jobs", jobs?.property_detail.host_id)
    ...
    const fetchUserDetails = async (userId: string) => {
        ...
        try {
            const response = await getUserDetail(parseInt(userId), 'host');
    ...
    useEffect(() => {
        fetchUserDetails(jobs?.property_detail.host_id);
    }, []);
